...
# defines data source and parameters for search
data_source='yahoo'

start_date='2017-01-01'
end_date='2020-08-24'

#creates data table for U.S. companies
us_dict={
    'Amazon':'AMZN',
    'Apple': 'AAPL',
...
# creates data table for Chinese companies
china_dict={
    "Tencent":"0700.HK", 
    "HSBC":"0005.HK",
    "CCB":"0939.HK",
...
#deals with nan values in China table
